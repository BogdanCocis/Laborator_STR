public class ExecutionThread1 extends Thread {
    ...
    int sleep_min, sleep_max, activity_max,activity_min;

    public ExecutionThread1(Integer monitor1,Integer monitor2, int sleep_min, int sleep_max, int activity_min, int activity_max)
    {
